...
public class PageEconomicActivity extends Activity {
...
//            progressDialog = ProgressDialog.show(PageAppleActivity.this, "", "Loading, please wait...");
        ...
        protected Object doInBackground(Object... params) {
            ...
            myCategroyArray = NewsAPI.getSourceCategory(NewsAPI.ECONOMY);
		...
		// TODO Auto-generated method stub
         ...
         myList.setOnItemClickListener(new OnItemClickListener() {
 			...
 			public void onItemClick(AdapterView<?> parent, View view,
	 				...
	 				Intent intent = new Intent(PageEconomicActivity.this, PageNewsListActivity.class);
	 				Bundle bundle = new Bundle();
	 				bundle.putInt("CategoryInt", myCategroyArray.get(position).getId()); 
	 				bundle.putInt("SourceInt", 5); //means Apple
	 				bundle.putString("CategoryName", myCategroyArray.get(position).getCateName());
	 				bundle.putString("SourceName", "經濟日報");
...
//            progressDialog = ProgressDialog.show(PageAppleActivity.this, "", "Loading, please wait...");
        ...
        protected Object doInBackground(Object... params) {
            ...
            myPromotionArray = NewsAPI.getPromotionNews(5);
            return null;
        }
    ...
    private void setGalleryUI() {
        ...
        myGallery.setOnItemSelectedListener((new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                for (int i = 0; i < mDotsCount; i++) {
                	PageEconomicActivity.mDotsText[i].setTextColor(Color.GRAY);
                }

                PageEconomicActivity.mDotsText[position].setTextColor(Color.WHITE);
        ...
        myGallery.setOnItemClickListener(new OnItemClickListener() {
 			...
 			public void onItemClick(AdapterView<?> parent, View view,
	 				...
	 				Intent intent = new Intent(PageEconomicActivity.this, PageNewsDetailActivity.class);
	 				Bundle bundle = new Bundle();
	 				bundle.putInt("CategoryInt", myCategroyArray.get(position).getId()); 
	 				bundle.putInt("SourceInt", 5); //means Apple
